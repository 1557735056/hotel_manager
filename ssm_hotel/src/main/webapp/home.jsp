    ...
    <div class="layui-container">
        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
            ...
            <li data-id="login" class="layui-nav-item layui-hide-xs ">
                <a class="fly-case-active" data-type="toTopNav" href="/user/login.html;">登入</a>
            </li>
            <li data-id="register" class="layui-nav-item layui-hide-xs ">
                <a class="fly-case-active" data-type="toTopNav" href="/user/register.html">注册</a>
            </li>
        ...
        <div class="shop-temp" id="getIndexFloor">
            <c:forEach var="floor" items="${floorList}" varStatus="stauts">
                <c:if test="${stauts.index%2==0}">
                    <div class="temp-hot">
                        <div class="layui-container">
                            <p class="temp-title-cn"><span></span>${floor.name}<span></span></p>
                                        ...
                                        <div data-id="${room.id}" class="layui-col-xs6 layui-col-md3">
                                            ...
                                            <a class="template store-list-box fly-case-active" href="/room/${room.id}.html" data-type="toRoomInfo">
                                                ...
                                                <p class="price"> <span title="金额"> ￥${room.price} </span>
                                                    <span title="房号" style="color:  #fff;background: #0e88cc;padding: 3px;text-align: center;border: 1px solid #4cffb3;font-size: 13px;">
                                                        NO.${room.roomnum}
                                                    </span></p>
                                            </a>
                                        </div>
                ...
                <c:if test="${stauts.index%2!=0}">
                    <div class="temp-hot" style="background-color: #f2f2f2">
                        <div class="layui-container">
                            <p class="temp-title-cn"><span></span>${floor.name}<span></span></p>
                            <div class="layui-row layui-col-space20">
                                <c:forEach var="room" items="${roomList}">
