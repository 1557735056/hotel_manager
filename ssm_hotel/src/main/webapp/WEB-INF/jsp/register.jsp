                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline iphone">
                                    <div class="layui-input-inline">
                                        ...
                                        <input type="text" name="loginName" id="loginName" lay-verify="required" placeholder="请输入昵称" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
