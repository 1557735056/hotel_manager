    ...
    layui.use(['form', 'layer','table','upload'], function () {
        ...
        let tableIns =  table.render({
            ...
            cols: [[
                ...
                {field: 'liveNum', width: 100, title: "可住人数",align: 'center'},
        ...
        upload.render({
            elem: '.thumbImg' //绑定元素
            ,url: '/admin/roomType/uploadFile', //上传接口
